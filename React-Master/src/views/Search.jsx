      ...
      >
        <Tabs.Item title="Posts" active={true}>
          {postSearchData?.length ? (
            <div className="grid grid-flow-row gap-8 m-5 text-neutral-600 cover:gap-4 focus:text-lnav active:text-lnav cover:grid-cols-1 cover:m-1 xs:grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
        ...
        <Tabs.Item title="People">
          {userSearchData?.length ? (
            <div className="grid grid-flow-row gap-8 m-5 text-neutral-600 cover:gap-3 cover:grid-cols-1 cover:m-1 xs:grid-cols-2 sm:grid-cols-2 md:grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 ">
